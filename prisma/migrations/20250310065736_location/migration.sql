/*
  ...
  - You are about to drop the column `location` on the `mall` table. All the data in the column will be lost.
  ...
  - Added the required column `latitude` to the `Mall` table without a default value. This is not possible if the table is not empty.
  - Added the required column `longitude` to the `Mall` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `mall` DROP COLUMN `location`,
