/*
  ...
  - Added the required column `care` to the `Rooms` table without a default value. This is not possible if the table is not empty.
...
ALTER TABLE `rooms` DROP COLUMN `size`,
    ADD COLUMN `care` DOUBLE NOT NULL;
